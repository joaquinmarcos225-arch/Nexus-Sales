...
class OutreachMessage(Base):
    ...
    campaign: Mapped[Campaign] = relationship("Campaign", back_populates="outreach_messages")
...
class OutreachSequence(Base):
    ...
    campaign: Mapped[Campaign] = relationship("Campaign", back_populates="outreach_sequence")
